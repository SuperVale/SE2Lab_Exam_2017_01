...
app.post('/updatePizzasByPrice', function(request, response) 
{
	...
	if ( typeof request.body !== 'undefined' && request.body)
	{
            if ( typeof request.body.price !== 'undefined' && request.body.price &&  typeof request.body.increment !== 'undefined' &&
    ...
    if (true/*price!="not defined" && increment!="not defined" && price!="body undefined" && increment!="body undefined"*/)
	{
		//aceptable input
		//update a pizzas
